...
const CTA = () => {
  return (
    <Box mt={'9rem'}  bgGradient="linear(to-tr, #A55EFE, #724BFD, #3547F1, #3547F1, #2C79D5, #2C79D5)">
      <Box maxW={"1150px"} mx={"auto"} px={'50px'} py={'70px'}>
        <Flex alignItems={"center"}>
          <Box>
            <SectionHeading>
              Tools For Better Crypto Trading & Transactions
            </SectionHeading>
            <Text w={'47%'} py={'1em'} color={"white"} fontSize={"14px"} fontWeight={"400"}>
